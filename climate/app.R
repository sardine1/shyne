                                ...
                                tabItems(
                                  ...
                                  tabItem(tabName = "temperature_hourly",
                                          box(width = "100%",
                                              ...
                                              selectInput("station_hourly", label = "Станция:", 
                                                          ...
                                                          selected = "Novgorod"),
                                              dateInput("date_hourly_start", "Начальная дата:", min = "2000-01-01", value = "2022-01-01", startview = 'year'),
                                              dateInput("date_hourly_end", "Конечная дата:", min = "2000-01-01", value = "2022-03-31", startview = 'year'),
                                          ...
                                          box(width = "100%",
                                              ...
                                              selectInput("station_daily", label = "Станция:", 
                                                          ...
                                                          choices = list("Belogorka" = "26069", "Nikolaevskoe" = "26167", "Volosovo" = "26067", "Lomonosov" = "26060",
                                                                         ...
                                                                         "Belozersk" = "22939", "Njandoma" = "22854", "Kargopol" = "22845", "Vladimir" = "27532"), 
                                                          selected = "Novgorod"),
                                              dateInput("date_daily_start", "Начальная дата:", min = "2000-01-01", value = "2022-02-21"),
                                              dateInput("date_daily_end", "Конечная дата:", min = "2000-01-01", value = "2022-03-21"),
                                  ...
                                  tabItem(tabName = "temperature_monthly",
                                          box(width = "100%",
                                              ...
                                              dateInput("date_monthly_start", "Начальная дата:", value = "2021-02-01"),
                                              h6("Начальная дата – первое число месяца"),
                                              dateInput("date_monthly_end", "Конечная дата:", value = "2021-12-31"),
...
server <- function(input, output) {
  ...
  output$printplot_daily <- renderPlotly({
    ...
    daf_daily <- data.frame(
      Name = c("station_daily",
               "date_daily_start",
               "date_daily_end",
               "param_daily",
               "caption_daily"),
      Value = as.character(c(input$station_daily,
    ...
    df = meteo_ogimet(interval = "daily", date = c(input$date_daily_start, input$date_daily_end), station = input$station_daily)
